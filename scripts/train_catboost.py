"""Unified CatBoost trainer for the TESS, Kepler, and K2 catalogues."""
...
def parse_args(args: Iterable[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train a CatBoost model for exoplanet catalogues.")
    parser.add_argument(
        "dataset",
        nargs="?",
        default="kepler",
...
def main(cli_args: Iterable[str] | None = None) -> None:
    ...
    model_suffix = f"{dataset_key}_catboost"
    ...
    print(f"{dataset_name} CatBoost training complete. Key metrics:")
